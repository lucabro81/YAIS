export namespace Const {
    ...
    export class Events {
        ...
        static SCROLL_EVENT_START_GOING_UP:string = "scroll.start.going.up";
        static SCROLL_EVENT_GOING_UP:string = "scroll.going.up";
        static SCROLL_EVENT_FINISH_GOING_UP:string = "scroll.finish.going.up";
